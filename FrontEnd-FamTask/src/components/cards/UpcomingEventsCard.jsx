        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white
                     rounded-lg font-medium hover:from-orange-600 hover:to-red-600
          ...
          <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2">
            {events.map((event, idx) => (
              <motion.div
                ...
                className="p-4 rounded-xl border border-gray-100 hover:border-orange-200
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-800 mb-1 group-hover:text-orange-600
                                     transition-colors">
                          {event.title}
                        </h4>
                        {event.description && (
                    ...
                    {/* Actions - Solo visible al hacer hover */}
                    {canEditEvent && canEditEvent(event) && (
                      <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100
                                    opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <button
                          onClick={() => onEditEvent(event)}
                          className="px-3 py-1.5 text-sm text-orange-600 hover:bg-orange-50
